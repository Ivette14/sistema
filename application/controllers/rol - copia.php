...
public function index(){	 
	...
	function save_form(){ 
		...
		$this->form_validation->set_rules('opcion', 'opcion', 'trim|required|xss_clean');
		$this->form_validation->set_rules('id_opcion', 'id_opcion', 'trim|required|xss_clean');
 	...
 	$this->form_validation->set_message('required', 'campo %s requerido'); 
		...
		if( $this->form_validation->run() === FALSE ){ 
			...
			if( $id_rol==0 ){ 
				...
				$hecho=$this->model_rol->save_rol($id_opcion,$id_rol, $_POST ); 
			}else{ 
